...
const resources = {
  en: {
    translation: {
      ...
      "Back": "Back",
      "Language": "Language",
      "heroText": "Hey, I'm Pedro — a product designer based in São Paulo, passionate about surf, soccer, cognitive bias, behavior-driven interfaces, and the intersection of design and artificial intelligence.",
  ...
  pt: {
    translation: {
      ...
      "Back": "Voltar",
      "Language": "Idioma",
      "heroText": "Oi, eu sou Pedro — um designer de produtos em São Paulo, apaixonado por surf, futebol, viés cognitivo, interfaces orientadas por comportamento e a interseção entre design e inteligência artificial.",
